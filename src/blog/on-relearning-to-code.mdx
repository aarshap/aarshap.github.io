...
<ArticleMedia caption="Gatsby">
    <Image src="images/blog/on_relearning_to_code/gatsby_homepage.png" alt="Gatsby" className="has-shadow" />
</ArticleMedia>
...
<ArticleMedia caption="Styled Components">
    <Image src="images/blog/on_relearning_to_code/styled_components_homepage.png" alt="Styled Components homepage" className="has-shadow" />
</ArticleMedia>
...
<ArticleMedia caption="Ingenuity">
    <Image src="images/blog/on_relearning_to_code/bedsheet.jpg" alt="Bedsheet on my wall" className="has-shadow" />
</ArticleMedia>
