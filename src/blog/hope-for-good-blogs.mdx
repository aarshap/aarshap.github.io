...
<ArticleMedia caption="Defector's homepage">
    <Image src="images/blog/hope_for_good_blogs/defector.png" alt="Defector's homepage" className="has-shadow" />
</ArticleMedia>
...
<ArticleMedia caption="lol.">
    <Image src="images/blog/hope_for_good_blogs/the_guardian.png" alt="Very bad ads" className="has-shadow" />
</ArticleMedia>
