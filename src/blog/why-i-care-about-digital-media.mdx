...
<ArticleMedia caption="Welp.">
    <Image src="images/blog/why_i_care_about_digital_media/the_cut_screenshot.png" alt="Screenshot of The Cut's article on media job loss" className="has-shadow" />
</ArticleMedia>
